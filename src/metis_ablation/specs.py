...
ABLATION_LADDER: tuple[AblationSpec, ...] = (
    AblationSpec(
        ...
        depth_memory=False,
        dense_ffn_bf16=True,
        measured_tokens_per_second=2_260_487,
    ...
    AblationSpec(
        ...
        dense_ffn_bf16=True,
        iso_flop=False,
        measured_tokens_per_second=1_665_431,
        config_overrides={"activation_recompute_policy": "none"},
    ...
    AblationSpec(
        ...
        depth_memory=False,
        iso_flop=False,
        measured_tokens_per_second=587_748,
        config_overrides={"activation_recompute_policy": "none"},
    ),
    AblationSpec(
        index=4,
        ...
        depth_memory=False,
        iso_flop=False,
        measured_tokens_per_second=564_527,
        config_overrides={"activation_recompute_policy": "none"},
        notes=(
    ...
    AblationSpec(
        ...
        routed_k_mode="fixed", fixed_routed_k=4,
        depth_memory=False,
        measured_tokens_per_second=691_789,
    ...
    AblationSpec(
        ...
        pathway_mode="frozen",
        depth_memory=False,
        measured_tokens_per_second=571_263,
        config_overrides={"activation_recompute_policy": "layer"},
    ...
    AblationSpec(
        ...
        depth_memory=False,
        measured_tokens_per_second=537_280,
        config_overrides={"activation_recompute_policy": "none"},
    ),
    AblationSpec(
        index=8,
        ...
        isolates="WIDTH: fixed k against MoRE-Core's adaptive k",
        apus=80, micro_batch=6, grad_accum=1,
        continuation_mode="budgeted",
        routed_k_mode="fixed", fixed_routed_k=4,
        depth_memory=False,
        measured_tokens_per_second=577_749,
        config_overrides={"activation_recompute_policy": "none"},
    ),
    AblationSpec(
        index=9,
        ...
        isolates="DEPTH: fixed depth against MoRE-Core's adaptive depth",
        apus=40, micro_batch=12, grad_accum=1,
        continuation_mode="fixed_max", curriculum_max_passes=2,
        routed_k_mode="budgeted",
        depth_memory=False,
        measured_tokens_per_second=573_857,
        config_overrides={"activation_recompute_policy": "layer"},
    ),
    AblationSpec(
        index=10,
        ...
        routed_k_mode="budgeted",
        depth_memory=False,
        measured_tokens_per_second=576_904,
        config_overrides={"activation_recompute_policy": "none"},
    ),
    AblationSpec(
        index=11,
        ...
        routed_k_mode="budgeted",
        depth_memory=True,
        measured_tokens_per_second=567_686,
        config_overrides={"activation_recompute_policy": "none"},
    ),
    AblationSpec(
        index=12,
        ...
        depth_memory=False,
        measured_tokens_per_second=587_870,
        config_overrides={"activation_recompute_policy": "none"},
    ...
    AblationSpec(
        ...
        routed_k_mode="budgeted",
        depth_memory=False,
        measured_tokens_per_second=588_719,
        config_overrides={"activation_recompute_policy": "none"},
        notes=(
