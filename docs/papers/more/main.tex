...
\TODO{Three controlled stored-parameter sizes --- 0.61B, 1.81B, and 5.01B ---
...
at 5.01B this gives the parameter-matched dense control 20 tokens per stored
parameter rather than the clearly undertrained 10 that a 50B run would provide.
The controlled ladder is nearly logarithmic and holds the two-layer recurrent
block shape fixed. The question is whether the MoRE advantage holds, grows, or
shrinks with scale.}
...
controlled ladder now reaches 5.01B stored parameters, but conclusions about
